...
var Place = (function () {
    ...
    Place.prototype.getExit = function () {
        return this.exit;
    };
    Place.prototype.setEntrance = function (place) {
        this.entrance = place;
    };
    Place.prototype.isWater = function () {
        return this.water;
    };
    ...
    Place.prototype.getBees = function () {
        return this.bees;
    };
...
var AntColony = (function () {
    ...
    AntColony.prototype.getFood = function () {
        return this.food;
    };
    AntColony.prototype.increaseFood = function (amount) {
        this.food += amount;
    };
    AntColony.prototype.getPlaces = function () {
        return this.places;
    };
    AntColony.prototype.getEntrances = function () {
        return this.beeEntrances;
    };
    AntColony.prototype.getQueenPlace = function () {
        return this.queenPlace;
    };
    AntColony.prototype.queenHasBees = function () {
        return this.queenPlace.getBees().length > 0;
    };
    AntColony.prototype.getBoosts = function () {
        return this.boosts;
    };
...
var AntGame = (function () {
    ...
    AntGame.prototype.getTurn = function () {
        return this.turn;
    };
    AntGame.prototype.gameIsWon = function () {
        ...
        else if (this.colony.getAllBees().length + this.hive.getBees().length ===
            0) {
            return true;
        }
        return undefined;
    ...
    AntGame.prototype.getPlaces = function () {
        return this.colony.getPlaces();
    };
    AntGame.prototype.getFood = function () {
        return this.colony.getFood();
    };
    AntGame.prototype.getHiveBeesCount = function () {
